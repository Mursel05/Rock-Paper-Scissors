...
const Choosing = ({ onSetUserPicked }) => {
  ...
  return (
    <div className="choosing">
      ...
      <div onClick={() => navigate("/game/paper")} className="paper item-wrap">
        <div className="item">
      ...
      <div onClick={() => navigate("/game/rock")} className="rock item-wrap">
        <div className="item">
      ...
      <div
        onClick={() => navigate("/game/scissors")}
        className="scissors item-wrap"
      >
        <div className="item">
